...
MODIFICATION_SIGNATURES = {
    'elongate': {
        ...
        'parameters': [
            {
                'label': 'axis',
                'documentation': 'Crystallographic axis: a, b, or c'
            },
            {
                'label': 'ratio',
    ...
    'taper': {
        ...
        'parameters': [
            {
                'label': 'direction',
                'documentation': 'Taper direction: +c, -c, +a, -a, +b, -b'
            },
            {
                'label': 'factor',
                'documentation': 'Taper factor (0-1). Example: 0.5'
            }
        ]
    },
    'bevel': {
        ...
        'parameters': [
            {
                'label': 'edges',
                'documentation': 'Edge set to bevel: all, vertical, horizontal'
            },
            {
                'label': 'width',
    ...
    for mod_name in MODIFICATION_SIGNATURES:
        ...
        for match in re.finditer(pattern, text_before, re.IGNORECASE):
            ...
            if ')' not in after_open:
                ...
                return (mod_name, min(active_param, len(MODIFICATION_SIGNATURES[mod_name]['parameters']) - 1))
